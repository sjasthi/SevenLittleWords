...
<title>modify words</title>
  ...
  <h1>modify word</h1>
  <i style="margin: 5px;">Enter your words</i>
  </div>
  <br>
</head>

<div class="grid-container" id="sliderGame">
  <div class="update">Hel</div>
  <div class="update">lo </div>
  <div class="update">Wor</div>
  <div class="updates">ld </div>
  <div class="update">!  </div>
  <div class="update">We </div>
  <div class="update">are</div>
  <div class="update">Tea</div>
  <div class="update">m A</div>
  <div class="update">lli</div>
  <div class="update">gat</div>
  <div class="update">ors</div>
  <div class="update">!  </div>
...
<div style="text-align: center;">
 <!--  <label for="Quote" style="text-align: center;">Enter Quote:</label> -->
  ...
  <button class="button" type="submit" value="Submit" onclick="quoteFunction()" >Enter words</button>
</div>
...
<form action="modify.php" style="text-align: center;">
